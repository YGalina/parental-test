...
function gateStep() {
  ...
  return { text: "Готово! Ваш архетип посчитан.\n\nЧтобы открыть результат — подпишитесь на канал <b>«Какой я родитель»</b>. Там каждую неделю разборы реальных ситуаций и фразы для разговора с ребёнком.", keyboard: kb(rows) };
}
